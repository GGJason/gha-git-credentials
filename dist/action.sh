...
echo "INPUTS: global_flag=${_GIT_GLOBAL_OPTION} name=${INPUT_NAME} email=${INPUT_EMAIL} actor=${INPUT_ACTOR}" > gha.log
...
echo "VALUES: global_flag=${_GIT_GLOBAL_OPTION} name=${INPUT_NAME} email=${INPUT_EMAIL} actor=${INPUT_ACTOR}"  >> gha.log
